        ...
        <div>
            ...
            >
                <div className='relative'>
                    ...
                    <h3 className='text-lg md:text-5xl text-white'>Empowering Smart Microloans</h3>
                    <p className='text-xl text-white my-5'>Track requests, approvals, and repayments with complete clarity and real-time insights.</p>
                        <Link to="/" className='btn bg-primary rounded-full md:text-lg'>Apply For Loan</Link>
                    </div>
                </div>
                <div className='relative' >
                    {/* <img src={bannerImg2} /> */}
                    ...
                    <div className='absolute bottom-0 lg:bottom-[300px] ml-0 lg:left-[100px] lg:w-[600px] flex flex-col gap-2 ms-20 text-left'>
                    <h3 className='text-lg md:text-5xl text-white'>Your Microloan Workflow, Simplified</h3>
                    <p className='text-xl text-white my-5'>Manage loan applications, verify borrowers, and streamline approvals—all in one place..</p>
                        <Link className='btn bg-primary rounded-full md:text-lg'>Apply For Loan</Link>
                    </div>
                </div>
                <div className='relative'>
                    {/* <img src={bannerImg3} /> */}
                    <img src="https://html.dynamiclayers.net/dl/charitify/img/slider-1.jpg" alt="" />
                     ...
                     <div className='absolute  bottom-0 lg:bottom-[300px] ml-0 lg:left-[100px] lg:w-[600px] flex flex-col gap-2 ms-20 text-left'>
                    <h3 className='text-lg md:text-5xl text-white'>Fast, Transparent & Reliable Microloan Management</h3>
